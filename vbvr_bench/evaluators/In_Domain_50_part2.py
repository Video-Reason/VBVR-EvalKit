...
from ..utils import compute_optical_flow, detect_shapes, color_distance, safe_distance, normalize_frame_size, compute_ssim
...
class DirectedGraphNavigationEvaluator(BaseEvaluator):
    ...
    def _evaluate_task_specific_interleave(
        ...
        scores['path_quality'] = compute_ssim(pred_path, gt_path) ** 2
